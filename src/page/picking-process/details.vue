<template>
    <div class="pick-details pb-lg">
        <mt-header fixed :title="`PL${this.pickingNumber} 拣货单任务`">
            ...
            'background-color': '#fff','padding':'3px 0',}">拣货完成</request-button>
        </mt-header>
 ...
 <!--           <mt-tab-container-item id="tab-container1">
                ...
                &lt;!&ndash;<table class="turnover-table" v-if="turnoverBoxData.length>0">&ndash;&gt;
                    &lt;!&ndash;<tr><td colspan="2" style="line-height: 2.5em;">已绑定周转箱号（{{turnoverBoxNumber}}）</td></tr>&ndash;&gt;
                    &lt;!&ndash;<tr v-for="(box,index) in turnoverBoxData">&ndash;&gt;
                        &lt;!&ndash;<td>{{box.box}}</td>&ndash;&gt;
                        &lt;!&ndash;&lt;!&ndash;<td><i v-if="box.status===1" class="iconfont icons icon-dagou" style="height: 1em;line-height: 1em;"></i></td>&ndash;&gt;&ndash;&gt;
                        &lt;!&ndash;<td><i v-if="index===(turnoverBoxData.length-1)" class="iconfont icons icon-dagou" style="height: 1em;line-height: 1em;"></i></td>&ndash;&gt;
                    &lt;!&ndash;</tr>&ndash;&gt;
                &lt;!&ndash;</table>&ndash;&gt;
            ...
            <mt-tab-container-item id="tab-container3">
                ...
                <form class="form">
                  ...
                  <div class="outbox">
                      <div v-if="orderListData.length===0" style="display: flex;align-items: center; height:24px;">
                          <line-select
                                  ref="turnover_box"
                                  v-model="turnover_box"
                                  lineName="箱号"
                                  :sty="{'width':'150px','margin-left':'5px',}"
                                  iconRight="14px"
                      ...
                      <line-input ref="number" style="margin-top:7px;"
        ...
        <div style="position: absolute;left: 0;right: 0;bottom: 26px;">
        ...
        <!--<div>{{imgshow}}</div>-->
        <!--<mt-tabbar v-model="selected" :fixed="true"class="tab2">-->
            <!--&lt;!&ndash;<mt-tab-item id="tab1" @click.native.prevent="active='tab-container1'">&ndash;&gt;-->
                <!--&lt;!&ndash;绑箱&ndash;&gt;-->
            <!--&lt;!&ndash;</mt-tab-item>&ndash;&gt;-->
            <!--<mt-tab-item id="tab2" @click.native.prevent="active='tab-container2'" class="pick-path">-->
                <!--拣货路径-->
            <!--</mt-tab-item>-->
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            console.log(this.active,'4878788787878')
        ...
        methods:{
            ...
            get_details(orderId){
                this.$http(api_picking_process_details,orderId).then(res=>{
                    ...
                    if(first.turnover_box.length>0){
                        ...
                        console.log('yes',this.turnoverBoxData)
                        this.caluc_turnover_box();
                    }else{
                        console.log('no',this.turnoverBoxData)
            ...
            get_bind(){
                //console.log(this.detailsData[0].turnover_box,'497')
                let id = this.$route.query.id;
