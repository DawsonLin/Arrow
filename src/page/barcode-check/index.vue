<template>
    <div class="p-index">
        <mt-header fixed title="条码查询" style="margin-bottom:10px">
        ...
        <div class="pt-lg self">
            ...
            <selectDown :selectList="barcodeTypeList"  @chufa="select_change" v-model="barcode_type" @req="barcode_value_enter" :gitinput="getinput" style="margin-top:20px;"
...
<script>
    ...
    export default{
        ...
        updated(){
            console.log(this.getinput,'xxxxss')
        },
        methods:{
            sku_goods(sku){
                this.sku_name=sku;
