                ...
                <form class="form">
                    ...
                    <div class="text">
                        <div class="line-text" v-if="cargo">
                            <span>参考货位</span><span style="padding-left: 2%;">
                            {{cargo}}</span></div>
                    </div>
                    <line-input
                                ref="warehouse_cargo"
                    ...
                    <div class="line-button">
                        <div class="request_btn" style="margin-top:20px">
            ...
            <mt-tab-container-item id="tab-container2">
                <div>
                    <mt-cell style="position: fixed;z-index: 2;width: 100%;max-width: 640px;">
                        <table class="table-box"><tr><td width="15%">排序</td><td width="30%">货位</td><td width="30%">SKU</td><td width="25%">数量</td></tr></table>
                    </mt-cell>
        ...
        methods:{
            ...
            init(){
                ...
                this.$http(api_putaway_waiting_goods_list,data).then(res=>{
                    ...
                    console.log(code);
                    setTimeout(_=>this.$router.go(-1),1500);
            ...
            select_change(val){
                ...
                if(!!find){
                    ...
                    let order = this.cargoData.find(res=>{
                        console.log(res);
